<?php include_once 'components/quiz-process.php'; ?>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group premium-input-group">
                                ...
                                <input type="text" class="form-control bg-transparent text-white border-secondary border-opacity-50" id="title" name="title" placeholder="e.g. Modern Web Development">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control bg-transparent text-white border-secondary border-opacity-50" id="description" name="description" rows="3" placeholder="What is this quiz about?"></textarea>
                        </div>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select bg-transparent text-white border-secondary border-opacity-50" id="category_id" name="category_id">
                                    <option value="" disabled selected class="bg-dark">Choose a category...</option>
                                    <?php foreach($categories as $cat): ?>
                                        <option value="<?php echo $cat['id']; ?>" class="bg-dark"><?php echo sanitize($cat['name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-transparent text-white border-secondary border-opacity-50" id="time_limit" name="time_limit" value="10" min="0">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control bg-transparent text-white border-secondary border-opacity-50" id="passing_score" name="passing_score" value="50" min="1" max="100">
                                </div>
                            </div>
                        </div>
